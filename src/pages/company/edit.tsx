...
import { Col, Form, Row, Select, InputNumber, Input } from 'antd';
import { Edit, useForm, useSelect } from '@refinedev/antd';
import { getNameInitials } from '@/utilities';
import CustomAvatar from '@/components/custom-avatar';
import SelectOptionWithAvatar from '@/components/select-option-with-avatar';
import { UPDATE_COMPANY_MUTATION } from '@/graphql/mutations'; // Use the correct mutation for updating company
...
const EditPage = () => {
    const { saveButtonProps, formProps, formLoading, queryResult } = useForm({
        redirect: false,
        meta: {
            gqlMutation: UPDATE_COMPANY_MUTATION, // Use the correct mutation for updating company
        },
    });
